// This was by jsimpsonjr00 at a jsfiddle page. I just changed colors and stuff.
// id:rainer for canvas that executes this
...
( function ( $ ) {
    ...
    Raindrop.prototype = {
        ...
        randomizeSize: function ( ) {
            this.size.x = Math.floor( Math.random( ) * 4 + 1 ) * 3;
    ...
    $(document).ready( function () {
       var canvas = document.getElementById('rainer');
